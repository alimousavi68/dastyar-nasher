                    ...
                    <div id="item-<?php echo $item_id; ?>" class="table-item d-flex align-items-center justify-content-between gap-3 position-relative" data-guid="<?php echo $item_guid; ?>" data-resource-id="<?php echo $resource_id; ?>">
                        ...
                        <div class="action-bar d-flex align-items-center gap-2">
                            ...
                            <div class="priority-selector-group">
                                ...
                                <button type="button" class="scrape-link btn-priority high" data-id="<?php echo $item->id; ?>" data-guid="<?php echo $item_guid; ?>" data-priority="high" data-resource-id="<?php echo $resource_id; ?>">بالا</button>
                                <button type="button" class="scrape-link btn-priority medium" data-id="<?php echo $item->id; ?>" data-guid="<?php echo $item_guid; ?>" data-priority="medium" data-resource-id="<?php echo $resource_id; ?>">متوسط</button>
                                <button type="button" class="scrape-link btn-priority low" data-id="<?php echo $item->id; ?>" data-guid="<?php echo $item_guid; ?>" data-priority="low" data-resource-id="<?php echo $resource_id; ?>">کم</button>
                            </div>

                            <!-- Fetch Custom Button -->
                            <button type="button" class="scrape-link btn-fetch-custom position-relative" data-bs-toggle="tooltip" data-bs-title="واکشی مستقیم" data-id="<?php echo $item->id; ?>" data-guid="<?php echo $item_guid; ?>" data-priority="pending" data-resource-id="<?php echo $resource_id; ?>">
                            ...
                            <!-- Publish Now Button -->
                            <a href="javascript:void(0);" class="btn-action-yellow scrape-link position-relative" data-guid="<?php echo $item_guid; ?>" data-resource-id="<?php echo $resource_id; ?>" data-id="<?php echo $item_id; ?>" data-priority="now" data-bs-toggle="tooltip" data-bs-title="انتشار فوری">
                            ...
                            <a href="<?php echo $item_guid; ?>" target="_blank" class="btn-action-gray" data-bs-toggle="tooltip" data-bs-title="مشاهده اصلی">
                            ...
                            <!-- Delete Button -->
                            <a href="<?php echo esc_url(wp_nonce_url(add_query_arg(array('action' => 'delete_item', 'item_id' => $item_id)), 'cop_delete_item_nonce')); ?>" class="btn-action-danger delete-item-link" data-bs-toggle="tooltip" data-bs-title="حذف فید">
